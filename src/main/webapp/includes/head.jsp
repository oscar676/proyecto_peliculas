...
<%@page import="com.ipartek.formacion.oscarfonticoba.controladores.Mensaje"%>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">Peliculas v1.0</a>
            </div>
            <!-- /.navbar-header -->
